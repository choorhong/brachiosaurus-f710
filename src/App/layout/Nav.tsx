...
import { BuildOutlined, FileTextOutlined, FormOutlined, ContactsOutlined, SettingOutlined, UserOutlined, TeamOutlined, LogoutOutlined, RadarChartOutlined } from '@ant-design/icons'
    ...
    <Layout style={{ minHeight: '100vh' }}>
      ...
      >
        ...
        <Menu theme='dark' mode='inline' selectedKeys={[selectedKey]}>
          ...
          <Menu.Item key='vessel' icon={<RadarChartOutlined />}>
